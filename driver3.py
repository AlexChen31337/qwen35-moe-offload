"""
driver3.py — Final fine-tuning around ngl=16 q4_1 KV.
"""
...
def run_exp(exp_num, ngl, ctx, batch, ubatch, type_k, type_v, desc):
    print(f"\nEXP {exp_num}: ngl={ngl}, ctx={ctx}, batch={batch}, K={type_k}, V={type_v} | {desc}")
...
def main():
    ...
    experiments = [
        (16, 512, 32, 32, 'q4_1', 'q4_1', 'ngl=16 ctx=512 (pure speed)'),
        (16, 1024, 32, 32, 'q4_1', 'q4_1', 'ngl=16 ctx=1024'),
        (16, 4096, 32, 32, 'q4_1', 'q4_1', 'ngl=16 ctx=4096'),
        (16, 2048, 32, 16, 'q4_1', 'q4_1', 'ngl=16 ctx=2048 ubatch=16'),
        (16, 2048, 16, 16, 'q4_1', 'q4_1', 'ngl=16 ctx=2048 batch=16'),
        (16, 2048, 64, 32, 'q4_1', 'q4_1', 'ngl=16 ctx=2048 batch=64'),
        # Asymmetric at ngl=16
        (16, 2048, 32, 32, 'q4_1', 'q4_0', 'ngl=16 asym K=q4_1,V=q4_0'),
        (16, 2048, 32, 32, 'q4_0', 'q4_0', 'ngl=16 sym q4_0'),
    ]
    ...
    print('-' * 85)
    for r in sorted([x for x in all_r if x.get('status')=='ok'], key=lambda x: x['tps'], reverse=True)[:15]:
