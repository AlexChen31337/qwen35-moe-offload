"""
driver4.py — Final exploration around q4_0 KV at ngl=16.
"""
...
def main():
    ...
    experiments = [
        # q4_0 KV at various contexts with ngl=16
        (16, 512, 32, 32, 'q4_0', 'q4_0', 'ngl=16 q4_0 ctx=512'),
        (16, 1024, 32, 32, 'q4_0', 'q4_0', 'ngl=16 q4_0 ctx=1024'),
        (16, 4096, 32, 32, 'q4_0', 'q4_0', 'ngl=16 q4_0 ctx=4096'),
        (16, 8192, 32, 32, 'q4_0', 'q4_0', 'ngl=16 q4_0 ctx=8192'),
        # Batch tuning at q4_0 ngl=16 ctx=2048
        (16, 2048, 16, 16, 'q4_0', 'q4_0', 'ngl=16 q4_0 batch=16'),
        (16, 2048, 64, 32, 'q4_0', 'q4_0', 'ngl=16 q4_0 batch=64'),
        # q4_0 with ngl=15 ctx=2048 (less VRAM pressure)
        (15, 2048, 32, 32, 'q4_0', 'q4_0', 'ngl=15 q4_0 ctx=2048'),
        # Asym at ngl=16 ctx=2048: K=q4_0, V=q8_0 (reversed — keep values precise)
        (16, 2048, 32, 32, 'q4_0', 'q8_0', 'ngl=16 asym K=q4_0,V=q8_0'),
    ]
